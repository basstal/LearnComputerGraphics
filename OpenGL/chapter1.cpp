...
// 	Shader shaderProgram = Shader("VertexShader1.glsl", "FragmentShader1.glsl");
...
// 	// unsigned int shaderProgram = ProcessShader("VertexShader1.glsl", "FragmentShader1.glsl");
// 	// unsigned int shaderProgram1 = ProcessShader("VertexShader1.glsl", "FragmentShader1.glsl");
...
// 		glm::mat4 projection;
// 		projection = glm::perspective(glm::radians(camera.Zoom), aspect_ratio[i], 0.1f, 100.0f);
