...
//     // -------------------------
//     Shader shaderGeometryPass = Shader("VertexShaderDeferred.glsl", "FragmentShaderDeferred.glsl", "");
//     Shader shaderLightingPass = Shader("VertexShaderQuad1.glsl", "FragmentShaderQuad1.glsl", "");
