...
int main()
{
    ...
    unsigned int diffuseTex = loadImage("bricks2.jpg", "../../Assets/",  false);
    unsigned int normalTex = loadImage("bricks2_normal.jpg", "../../Assets/",  false);
    unsigned int depthTex = loadImage("bricks2_disp.jpg", "../../Assets/",  false);
