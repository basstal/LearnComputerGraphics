...
int main()
{
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        bloomShader.setFloat("constant", constant);
        bloomShader.setFloat("linear", linear);
        bloomShader.setFloat("quadratic", quadratic);
        bloomShader.setFloat("ambientStrength", ambientStrength);
        bloomShader.setFloat("shininess", shininess);
