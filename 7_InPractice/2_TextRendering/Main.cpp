...
extern int textRendering(GLFWwindow * window);

extern void textRendering_setup(GLFWwindow *);

std::map<std::string, FuncSet> maps{
    {"TextRendering", FuncSet(textRendering_setup, textRendering)},
};
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(1920, 1080, "TextRendering", NULL, NULL);
    if (window == NULL)
    {
