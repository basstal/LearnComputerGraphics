...
void framebuffers_setup(GLFWwindow * window)
{
    ...
    // ** post-processing
    postProcessingShader = std::make_shared<Shader>("Shaders/4_5/FramebufferVS.vert", "Shaders/4_5/PostProcessingGaussianBlur.frag", nullptr);
...
void framebuffers_viewport(GLFWwindow* window)
{
    glBindFramebuffer(GL_FRAMEBUFFER, framebuffer);
